...
class TemplatingNodeResultOutput_String(pydantic_v1.BaseModel):
    id: str
...
class TemplatingNodeResultOutput_Number(pydantic_v1.BaseModel):
    id: str
...
class TemplatingNodeResultOutput_Json(pydantic_v1.BaseModel):
    id: str
    value: typing.Any
...
class TemplatingNodeResultOutput_ChatHistory(pydantic_v1.BaseModel):
    id: str
...
class TemplatingNodeResultOutput_SearchResults(pydantic_v1.BaseModel):
    id: str
...
class TemplatingNodeResultOutput_Error(pydantic_v1.BaseModel):
    id: str
...
class TemplatingNodeResultOutput_Array(pydantic_v1.BaseModel):
    id: str
...
class TemplatingNodeResultOutput_FunctionCall(pydantic_v1.BaseModel):
    id: str
