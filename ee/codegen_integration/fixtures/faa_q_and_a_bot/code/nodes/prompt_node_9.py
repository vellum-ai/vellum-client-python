...
class PromptNode9(InlinePromptNode):
        ...
        ChatMessagePromptBlock(
            ...
            blocks=[
                RichTextPromptBlock(
                    ...
                    cache_config=None,
                    blocks=[
                        PlainTextPromptBlock(state="ENABLED", cache_config=None, text=" Question:\n---------------\n"),
                        VariablePromptBlock(state="ENABLED", cache_config=None, input_variable="question"),
                        PlainTextPromptBlock(
                            state="ENABLED", cache_config=None, text="\n\nPolicy Quotes:\n-----------------------\n"
                        ),
    ...
    prompt_inputs = {"question": MostRecentMessage.Outputs.result, "context": FormattedSearchResults.Outputs.result}
