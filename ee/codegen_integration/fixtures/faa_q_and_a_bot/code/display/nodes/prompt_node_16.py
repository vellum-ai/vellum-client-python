...
class PromptNode16Display(BaseInlinePromptNodeDisplay[PromptNode16]):
    ...
    prompt_input_ids_by_name = {
        "most_recent_message": UUID("0f0f394c-dc7d-46a1-9217-24c1e59b273a")
    }
    node_input_ids_by_name = {
        "most_recent_message": UUID("0f0f394c-dc7d-46a1-9217-24c1e59b273a")
    }
    output_display = {
        PromptNode16.Outputs.text: NodeOutputDisplay(
            id=UUID("4d31e604-6711-4a12-b618-476bfc304f09"), name="text"
        ),
    ...
    port_displays = {
        PromptNode16.Ports.default: PortDisplayOverrides(
            id=UUID("aa013fc4-618d-4cf4-88ce-639c56588aa3")
        )
    }
    display_data = NodeDisplayData(
        position=NodeDisplayPosition(x=2694, y=1100), width=480, height=168
    )
