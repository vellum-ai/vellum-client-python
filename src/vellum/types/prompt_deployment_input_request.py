...
class PromptDeploymentInputRequest_String(pydantic_v1.BaseModel):
    name: str
    value: str
...
class PromptDeploymentInputRequest_Json(pydantic_v1.BaseModel):
    name: str
...
class PromptDeploymentInputRequest_ChatHistory(pydantic_v1.BaseModel):
    name: str
