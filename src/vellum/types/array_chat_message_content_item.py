...
class ArrayChatMessageContentItem_String(pydantic_v1.BaseModel):
    value: str
...
class ArrayChatMessageContentItem_FunctionCall(pydantic_v1.BaseModel):
...
class ArrayChatMessageContentItem_Image(pydantic_v1.BaseModel):
    value: VellumImage
