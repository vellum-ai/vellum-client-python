...
class SubworkflowNodeDisplay(BaseSubworkflowDeploymentNodeDisplay[SubworkflowNode]):
    ...
    node_input_ids_by_name = {
        "chat_history": UUID("76519b3c-285d-425d-ba7a-ce7300e4ed9c")
    }
    output_display = {
    ...
    port_displays = {
        SubworkflowNode.Ports.default: PortDisplayOverrides(
            id=UUID("de5b0a72-e46f-4534-89a9-b78725694dd2")
        )
    }
    display_data = NodeDisplayData(
        position=NodeDisplayPosition(x=3914, y=631), width=None, height=None
    )
