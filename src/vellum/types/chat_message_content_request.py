...
class ChatMessageContentRequest_String(pydantic_v1.BaseModel):
    value: str
...
class ChatMessageContentRequest_FunctionCall(pydantic_v1.BaseModel):
...
class ChatMessageContentRequest_Array(pydantic_v1.BaseModel):
...
class ChatMessageContentRequest_Image(pydantic_v1.BaseModel):
