...
class NodeInputVariableCompiledValue_String(pydantic_v1.BaseModel):
    node_input_id: str
    key: str
...
class NodeInputVariableCompiledValue_Number(pydantic_v1.BaseModel):
    node_input_id: str
    key: str
...
class NodeInputVariableCompiledValue_Json(pydantic_v1.BaseModel):
    node_input_id: str
    key: str
    value: typing.Any
...
class NodeInputVariableCompiledValue_ChatHistory(pydantic_v1.BaseModel):
    node_input_id: str
    key: str
...
class NodeInputVariableCompiledValue_SearchResults(pydantic_v1.BaseModel):
    node_input_id: str
    key: str
...
class NodeInputVariableCompiledValue_Error(pydantic_v1.BaseModel):
    node_input_id: str
    key: str
...
class NodeInputVariableCompiledValue_Array(pydantic_v1.BaseModel):
    node_input_id: str
    key: str
...
class NodeInputVariableCompiledValue_FunctionCall(pydantic_v1.BaseModel):
    node_input_id: str
    key: str
