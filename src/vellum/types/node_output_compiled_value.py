...
class NodeOutputCompiledValue_String(pydantic_v1.BaseModel):
...
class NodeOutputCompiledValue_Number(pydantic_v1.BaseModel):
...
class NodeOutputCompiledValue_Json(pydantic_v1.BaseModel):
    value: typing.Any
    node_output_id: str
    state: typing.Optional[WorkflowNodeResultEventState] = None
...
class NodeOutputCompiledValue_ChatHistory(pydantic_v1.BaseModel):
...
class NodeOutputCompiledValue_SearchResults(pydantic_v1.BaseModel):
...
class NodeOutputCompiledValue_Error(pydantic_v1.BaseModel):
...
class NodeOutputCompiledValue_Array(pydantic_v1.BaseModel):
...
class NodeOutputCompiledValue_FunctionCall(pydantic_v1.BaseModel):
