...
class ChatMessageContent_String(pydantic_v1.BaseModel):
    value: str
...
class ChatMessageContent_FunctionCall(pydantic_v1.BaseModel):
...
class ChatMessageContent_Array(pydantic_v1.BaseModel):
...
class ChatMessageContent_Image(pydantic_v1.BaseModel):
    value: VellumImage
