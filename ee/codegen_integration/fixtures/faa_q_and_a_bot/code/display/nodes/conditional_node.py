...
class ConditionalNodeDisplay(BaseConditionalNodeDisplay[ConditionalNode]):
    ...
    condition_ids = [
        ConditionId(
            id=UUID("4188bda5-5c07-490e-9e17-7e1df1e4fb3a"),
            rule_group_id=UUID("c18a30e5-038a-450d-a2c9-5e385aecb2e5"),
        ),
        ConditionId(
            id=UUID("e2815ae8-9b09-47e3-bd3f-5f17c9d96a31"),
            rule_group_id=UUID("b20bfb89-cb0b-4a17-9135-c0bd3206173b"),
        ),
        ConditionId(
            id=UUID("9be476a3-5757-4faa-b3a6-8383924946f0"),
            rule_group_id=UUID("c321e3d0-e6ee-437b-8860-fc1af277d01b"),
        ),
        ConditionId(
            id=UUID("8a38731c-a4e8-4f1d-a4a3-8419119294f6"), rule_group_id=None
        ),
    ]
    node_input_ids_by_name = {
        "e23d8319-e907-41e2-ad95-2be4e6aafbb3.field": UUID(
            "e50c08a5-35db-4415-9fa2-40d0d36a16b2"
        ),
        "e23d8319-e907-41e2-ad95-2be4e6aafbb3.value": UUID(
            "bf5d2644-7159-4fd7-b0f0-703075645e44"
        ),
        "60b216e7-9999-4e1d-bce9-0050f29538e1.field": UUID(
            "c3175b80-ba17-4adf-9f51-3d45daff1464"
        ),
        "60b216e7-9999-4e1d-bce9-0050f29538e1.value": UUID(
            "2403091a-f4c6-42e4-9a97-0a05c184653f"
        ),
        "d8e94b2f-e9b5-484c-bd0c-a388747153b9.field": UUID(
            "e4aa9f5b-9934-4f58-9611-0c1c767bae9b"
        ),
        "d8e94b2f-e9b5-484c-bd0c-a388747153b9.value": UUID(
            "2398764a-060b-4ee9-9531-60e06b2c95b9"
        ),
    }
    port_displays = {
        ConditionalNode.Ports.branch_1: PortDisplayOverrides(
            id=UUID("d4f0db7d-b04a-4c4d-b9d3-aa3eb61fa3a2")
        ),
        ConditionalNode.Ports.branch_2: PortDisplayOverrides(
            id=UUID("d3489082-f03f-4121-ae60-877fd361c5fe")
        ),
        ConditionalNode.Ports.branch_3: PortDisplayOverrides(
            id=UUID("a913cb88-261b-4fa8-9915-d215e19749ee")
        ),
        ConditionalNode.Ports.branch_4: PortDisplayOverrides(
            id=UUID("fec240f8-8baf-40f9-87e7-f268bff4ed94")
        ),
    }
